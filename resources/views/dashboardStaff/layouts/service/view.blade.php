            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <template x-for="(row, index) in filteredData" :key="index">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="row.durasi_service"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="row.harga_service"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="row.pembuat_service"></td>
    ...
    <div class="flex items-start gap-2">
        ...
        <span class="text-gray-700" x-text="selectedRow.pembuat_service"></span>
            ...
            <div class="flex justify-between items-center mt-6 pt-4 border-t">
                <!-- Edit Button -->
                <a 
                    :href="'{{ url('/dashboard/staff/service/edit') }}/' + selectedRow.id"
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <template x-if="confirmDelete">
                        <form :action="'{{ url('/dashboard/staff/service') }}/' + selectedRow.id" method="POST" class="flex items-center gap-2">
                            @csrf
                            @method('DELETE')
